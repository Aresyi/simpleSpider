			...
			public void itemStateChanged(ItemEvent e) {
				if(e.getStateChange() == ItemEvent.SELECTED){
					...
					if(jCoboBox_iuCode1.getSelectedItem() != null){
						String key = ((Industry)jCoboBox_iuCode1.getSelectedItem()).getKey();
						MyLog.logInfo(key);
...
//        pan1.setBackground(Color.GRAY);
    ...
    private void connectJButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	if(iuCode2 == null || Toolbox.isEmptyString(((Industry)iuCode2).getValue())){
    		msg += "  请选择正确的对应行业" ;
    	}
    	...
    	new Thread(new Runnable() {
			...
			public void run() {
				...
				businessProcess(keyword, startURL, industry.getKey(),industry.getValue(), minTime, maxTime);
			}
		}).start();
    }
	...
	class MyCellRenderer extends JLabel implements ListCellRenderer<Object>{
	                                                  ...
	                                                  boolean cellHasFocus)
	    {
	        if (value != null)
	         {
	             setText(((Industry)value).getValue());
